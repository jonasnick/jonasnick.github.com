...
Therefore the agent will wander around to collect knowledge about his environment and then exploit it according to its motivation.

**Update** Some of my successors enhanced Mario's capabilities and submitted a [great video demonstration that went viral](https://www.youtube.com/watch?v=AplG6KnOr2Q) to the AAAI Video Competition 2015.
